 ...
 */
package com.framework.victorafonso.event;
...
public class CheckoutCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2578060407807603340L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CheckoutCreatedEvent\",\"namespace\":\"com.framework.victorafonso.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[\"string\"]},{\"name\":\"status\",\"type\":[\"string\"]}]}");
   ...
   */
  public static com.framework.victorafonso.event.CheckoutCreatedEvent.Builder newBuilder() {
    return new com.framework.victorafonso.event.CheckoutCreatedEvent.Builder();
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.framework.victorafonso.event.CheckoutCreatedEvent.Builder newBuilder(com.framework.victorafonso.event.CheckoutCreatedEvent.Builder other) {
    if (other == null) {
      return new com.framework.victorafonso.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.framework.victorafonso.event.CheckoutCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.framework.victorafonso.event.CheckoutCreatedEvent.Builder newBuilder(com.framework.victorafonso.event.CheckoutCreatedEvent other) {
    if (other == null) {
      return new com.framework.victorafonso.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.framework.victorafonso.event.CheckoutCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CheckoutCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.framework.victorafonso.event.CheckoutCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.framework.victorafonso.event.CheckoutCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.framework.victorafonso.event.CheckoutCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.framework.victorafonso.event.CheckoutCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.framework.victorafonso.event.CheckoutCreatedEvent.Builder setStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.framework.victorafonso.event.CheckoutCreatedEvent.Builder clearStatus() {
      status = null;
