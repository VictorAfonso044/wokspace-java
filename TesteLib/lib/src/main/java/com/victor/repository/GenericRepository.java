...
public class GenericRepository {
	...
	public String extrairKey(Map<String, String> parametro, boolean insert, boolean virgula) {
	...
	public String tableData(List data) {
	...
	public String[] converterData(String tabela, Map<String, String> objeto) {
	...
	public Map<String, HashSet<String>> doWork(){
		...
		return session.doReturningWork(new TesteWork());
	}
}